...
public class SorcererTower extends Tower {
    ...
    public SorcererTower(Environnement env, int tHp, int tDmg, int tId, double tRange, double tX, double tY, int tSpeedAttack, int sTdmgPerSec, int sCost, int sTZoneDuration, int sDmgPersec) {
